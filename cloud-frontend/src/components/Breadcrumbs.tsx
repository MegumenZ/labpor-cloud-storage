...
export default function Breadcrumbs({ items, onNavigate }: BreadcrumbsProps) {
  ...
  return (
    <div className="flex items-center gap-1.5 mb-6 text-sm text-muted-foreground bg-card/60 backdrop-blur-md px-3.5 py-2 rounded-2xl border border-border/55 w-fit shadow-sm hover:shadow-md transition-all duration-300 select-none">
      <button
